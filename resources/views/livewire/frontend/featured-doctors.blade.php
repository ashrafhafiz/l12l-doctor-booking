            ...
            @foreach ($featuredDoctors as $featuredDoctor)
                <div
                    ...
                    <div class="flex items-center gap-x-4">
                        <livewire:frontend.profile-image :id="$featuredDoctor->id" />
                        <div class="grow">
                            <h3 class="font-medium text-gray-800 dark:text-neutral-200">
                                Dr. {{ $featuredDoctor->user->name }}
                            </h3>
                            <p class="text-xs uppercase text-gray-500 dark:text-neutral-500">
                                {{ $featuredDoctor->speciality->name }} / {{ $featuredDoctor->hospital_name }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between items-center mt-5">
                        ...
                        <div class="flex space-x-2">
                            <a class="inline-flex justify-center items-center size-8 text-sm font-semibold rounded-lg border border-gray-200 text-gray-500 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-neutral-400 dark:border-neutral-700 dark:hover:bg-neutral-700"
                                href="{{ $featuredDoctor->twitter }}" target="_blank">
                            ...
                            <a class="inline-flex justify-center items-center size-8 text-sm font-semibold rounded-lg border border-gray-200 text-gray-500 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-neutral-400 dark:border-neutral-700 dark:hover:bg-neutral-700"
                                href="{{ $featuredDoctor->instagram }}" target="_blank">
                        ...
                        @if (auth()->user() != null)
                            <a href="/booking/page/{{ $featuredDoctor->id }}"
