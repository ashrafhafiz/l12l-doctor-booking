                ...
                <a class="group sm:flex rounded-xl" href="{{ auth()->check() ? '/article/' . $article->id . '' : '/login' }}">
                    <div
                        ...
                        <img class="size-full absolute top-0 start-0 object-cover"
                            src="{{ Storage::url($article->image) }}" alt="Image Description">
                    </div>
                    ...
                    <div class="grow">
                        <div class="p-4 flex flex-col h-full sm:p-6">
                            ...
                            <h3
                                class="text-lg sm:text-2xl font-semibold text-gray-800 group-hover:text-blue-600 dark:text-neutral-300 dark:group-hover:text-white">
                                {{ $article->title }}
                            </h3>
                                ...
                                <div class="flex items-center">
                                    <div class="flex-shrink-0">
                                        <img class="size-[46px] rounded-full"
                                            src="{{ Storage::url($article->author->doctor->image) }}"
