...
class BookingComponent extends Component
{
    ...
    public function fetchAvailableDates($doctor)
    {
        ...
        foreach ($schedules as $schedule) {
            ...
            $fromTime = Carbon::createFromFormat('H:i:s', $schedule->start_time);
            $toTime = Carbon::createFromFormat('H:i:s', $schedule->end_time);
    ...
    public function bookAppointment($slot)
    {
        ...
        $appointmentEmailData = [
            ...
            'appointment_type' => $this->appointment_type == 'onsite' ? 'onsite' : 'live consultation',
